...
echo '<!-- VCNT - Visitorcounter for Joomla 2.5 by Kubik-Rubik.de - Viktor Vogel -->';
?>
...
<?php if ($whoisonline == 1 OR $whoisonline == 2) : ?>
    ...
    <p><?php echo JText::sprintf('MOD_VCNT_USERONLINE', $guest, $member); ?></p>
        ...
        <?php foreach($users_online['usernames'] as $user_online) : ?>
            <li>
                <?php if (!empty($whoisonline_linknames)) : ?>
                    <a href="index.php?option=com_users&view=profile&member_id=<?php echo (int)$user_online['userid']; ?>">
